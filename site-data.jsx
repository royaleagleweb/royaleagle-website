...
const SERVICES = [
  ...
  },
  {
    ...
    intro: "Twelve years and 400+ WordPress builds. We architect sites with Elementor or Gutenberg, custom blocks, and structured ACF fields so your team can publish confidently. No spaghetti, no abandoned page builders.",
  ...
  },
  {
    ...
    hero: "Stores that ship — from launch to nine-figure revenue and beyond.",
    img: "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=1400&q=85",
    intro: "We've built and migrated 80+ Shopify and WooCommerce stores. Whether you need a fast first launch or a re-platform from BigCommerce to Shopify Plus, we know where the pitfalls live.",
  ...
  // ── Infrastructure ──────────────────────────────────────
  {
    ...
    bullets: ["Managed WordPress hosting (WP-Engine, Kinsta)", "Cloudflare CDN + WAF", "Free SSL renewal & DNS management", "Daily off-site backups, 30-day retention", "24/7 monitoring with human escalation", "30-day money-back guarantee on every plan"],
    price: "Custom quote",
  ...
  // ── Marketing ───────────────────────────────────────────
  {
    ...
    faqs: [{"q":"What's included in a full marketing retainer?","a":"Quarterly strategy and roadmap; ongoing content production; technical and local SEO; paid Google and Meta ads management; email and SMS automation flows; conversion-rate optimization; monthly performance reviews with live dashboards."},{"q":"How is this different from hiring an in-house marketing team?","a":"An in-house team gives you one or two specialists for a six-figure salary plus benefits. A retainer with us gives you a full team — strategist, content lead, SEO, paid media, email — for less than half that."},{"q":"What kinds of reporting do you provide?","a":"Live Looker Studio dashboards updated daily, monthly written performance summaries with insights, and quarterly business reviews where we go through the strategy and roadmap end-to-end."},{"q":"How quickly should I expect results?","a":"Paid campaigns deliver measurable results within the first 30 days. SEO programs typically show measurable lift in 90 to 120 days. Content programs compound — meaningful organic traffic gains usually visible in months 3 to 6."},{"q":"Do you handle the creative work too, or just strategy?","a":"Both. We have in-house designers, copywriters, and video producers. You won't need to coordinate a separate creative agency."}],
  },
  {
    ...
    intro: "Google Premier Partner and Meta Business Partner status, certified specialists, and a transparent reporting model. We treat every dollar of your media budget like it's our own.",
  ...
  },
  {
    ...
    intro: "Our design team handles everything from new logos to ad creative to product UI. One creative director keeps the brand consistent across every surface.",
...
const CASE_STUDIES = [
  { slug: "integramed-orthopedics", brand: "IntegraMed Orthopedics", tag: "Healthcare", year: "2026", color: "#3A6B7A", services: ["Web Design", "WordPress", "SEO", "Local Lead Gen"], summary: "Digital rebuild for South Florida's largest orthopedic and spine wellness clinic.", impact: [["+184%", "Organic traffic"], ["3.4x", "MQLs"], ["0.8s", "LCP"], ["42K× lift", "MRR from paid"]], imgs: ["https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=1200&q=85","https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=1200&q=85","https://images.unsplash.com/photo-1591343395082-e120087004b4?w=1200&q=85","https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=1200&q=85"] },
  { slug: "seeq-supplements", brand: "SEEQ Supplements", tag: "E-commerce", year: "2025", color: "#7A3A56", services: ["Shopify", "Brand Identity", "Paid Search", "CRO"], summary: "From a single-flavor startup to a fast-growing nine-figure DTC brand in three years.", impact: [["14M× lift", "Year-3 revenue"], ["2.8x", "Blended ROAS"], ["+312%", "Subscriber growth"], ["38%", "Repeat rate"]], imgs: ["https://images.unsplash.com/photo-1593095948071-474c5cc2989d?w=1200&q=85","https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=1200&q=85","https://images.unsplash.com/photo-1610725664285-7c57e6eeac3f?w=1200&q=85","https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=1200&q=85"] },
  { slug: "sea-walkn-charters", brand: "Sea Walk'n Charters", tag: "Hospitality", year: "2025", color: "#1F4A6B", services: ["Web Design", "Booking Engine", "Meta Ads", "Photography"], summary: "Luxury yacht charter brand with a custom booking flow and 213% bookings lift.", impact: [["+213%", "Summer bookings"], ["4.2x", "ROAS, Meta"], ["62%", "Mobile bookings"], ["1.8M× lift", "Annual GMV"]], imgs: ["https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?w=1200&q=85","https://images.unsplash.com/photo-1605281317010-fe5ffe798166?w=1200&q=85","https://images.unsplash.com/photo-1542228262-3d663b306a53?w=1200&q=85","https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=1200&q=85"] },
  { slug: "dle-lawyers", brand: "DLE Lawyers", tag: "Legal", year: "2024", color: "#3D2E1A", services: ["Brand", "WordPress", "SEO", "Google Ads"], summary: "Brickell personal-injury firm now drives 60% of intake from organic & paid search.", impact: [["60%", "Intake from search"], ["+148%", "Organic leads"], ["3.1x", "Paid efficiency"], ["18", "Markets ranked"]], imgs: ["https://images.unsplash.com/photo-1589994965851-a8f479c573a9?w=1200&q=85","https://images.unsplash.com/photo-1521791136064-7986c2920216?w=1200&q=85","https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=1200&q=85","https://images.unsplash.com/photo-1505664194779-8beaceb93744?w=1200&q=85"] },
  { slug: "united-nursery", brand: "United Nursery", tag: "Retail / B2B", year: "2024", color: "#2C4A2E", services: ["Headless Commerce", "Wholesale Portal", "Email Automation"], summary: "One of the Southeast's largest growers — B2B portal + 12 Klaviyo flows.", impact: [["14%", "Cart recovery"], ["+96%", "B2B reorders"], ["32", "Klaviyo flows"], ["4.2M× lift", "Recovered revenue"]], imgs: ["https://images.unsplash.com/photo-1466692476868-aef1dfb1e735?w=1200&q=85","https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=1200&q=85","https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?w=1200&q=85","https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=1200&q=85"] },
  { slug: "big-lu-pet-co", brand: "Big Lu Pet Co.", tag: "DTC Pet", year: "2023", color: "#7A5224", services: ["Brand", "Shopify", "TikTok Ads", "CRO"], summary: "Premium pet supplement brand acquired by a strategic 18 months post-launch.", impact: [["18mo", "To acquisition"], ["+847%", "TikTok-driven sales"], ["12M× lift", "Acquisition value"], ["6.4x", "TikTok ROAS"]], imgs: ["https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=1200&q=85","https://images.unsplash.com/photo-1561037404-61cd46aa615b?w=1200&q=85","https://images.unsplash.com/photo-1450778869180-41d0601e046e?w=1200&q=85","https://images.unsplash.com/photo-1530281700549-e82e7bf110d6?w=1200&q=85"] },
  { slug: "atlantic-bank", brand: "Atlantic Coastal Bank", tag: "Finance", year: "2024", color: "#1A3A5C", services: ["Brand Refresh", "WordPress", "Compliance", "Local SEO"], summary: "Community bank rebuild with WCAG AA, FDIC compliance, and 4-branch local SEO.", impact: [["WCAG AA", "Audited"], ["+72%", "Account applications"], ["4", "Branches ranked"], ["0", "Compliance findings"]], imgs: ["https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=1200&q=85","https://images.unsplash.com/photo-1556742044-3c52d6e88c62?w=1200&q=85","https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200&q=85","https://images.unsplash.com/photo-1556761175-4b46a572b786?w=1200&q=85"] },
  { slug: "sunbelt-realty", brand: "Sunbelt Realty Group", tag: "Real Estate", year: "2024", color: "#5C2A1A", services: ["Custom Theme", "MLS Integration", "Lead Gen", "Photography"], summary: "300-agent brokerage with live MLS integration and a 9% lead-to-list-appointment rate.", impact: [["9%", "Lead → appointment"], ["+204%", "Site sessions"], ["300", "Agents onboarded"], ["28K", "Listings indexed"]], imgs: ["https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1200&q=85","https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=1200&q=85","https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=1200&q=85","https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?w=1200&q=85"] },
  { slug: "pristinit-saas", brand: "Pristinit", tag: "B2B SaaS", year: "2025", color: "#2D3E66", services: ["Webflow", "Marketing Site", "Content", "ABM"], summary: "B2B SaaS marketing site rebuild — 184% organic growth, 3.4x MQLs in 6 months.", impact: [["+184%", "Organic"], ["3.4x", "MQLs"], ["72", "Target accounts"], ["42K× lift", "MRR added"]], imgs: ["https://images.unsplash.com/photo-1556761175-b413da4baf72?w=1200&q=85","https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=1200&q=85","https://images.unsplash.com/photo-1553877522-43269d4ea984?w=1200&q=85","https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&q=85"] },
  { slug: "alex-co-mobile", brand: "Alex Co.", tag: "Mobile App", year: "2024", color: "#3D2456", services: ["Mobile App", "Web Platform", "Brand", "Launch"], summary: "Mobile-first marketplace launch — 50K downloads in 90 days, 4.7 App Store rating.", impact: [["50K", "Downloads, 90 days"], ["4.7★", "App Store rating"], ["28%", "DAU/MAU"], ["2.1M× lift", "Seed raised post-launch"]], imgs: ["https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1200&q=85","https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&q=85","https://images.unsplash.com/photo-1547658719-da2b51169166?w=1400&q=85","https://images.unsplash.com/photo-1559028012-481c04fa702d?w=1400&q=85"] },
];

const BLOG_POSTS = [
  { slug: "ai-website-personalization-2026", title: "How AI personalization is reshaping marketing websites in 2026", cat: "AI", date: "May 18, 2026", read: "8 min", author: "Marcus Reyes", img: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=1400&q=85", excerpt: "Personalization used to mean swapping a first name into an email subject line. In 2026, it means rendering an entirely different landing page for a returning visitor than a first-time prospect — and AI is the difference." },
  { slug: "wordpress-vs-webflow-2026", title: "WordPress vs Webflow vs Shopify: a 2026 decision framework", cat: "Web Design", date: "May 11, 2026", read: "12 min", author: "Priya Sharma", img: "https://images.unsplash.com/photo-1547658719-da2b51169166?w=1400&q=85", excerpt: "Every quarter someone asks us which platform we'd build their site on. The honest answer is 'it depends' — but here are the four questions that actually decide it." },
  { slug: "lcp-under-1-second", title: "The five changes that took our clients' LCP below 1 second", cat: "Performance", date: "May 04, 2026", read: "10 min", author: "Jordan Thompson", img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1400&q=85", excerpt: "Google's Core Web Vitals threshold for 'Good' LCP is 2.5s. Half of our portfolio sits below 1.0s. Here's the work that gets you there." },
  { slug: "claude-for-sales-teams", title: "Five Claude workflows every sales team should be running by now", cat: "AI", date: "Apr 27, 2026", read: "9 min", author: "Sam Kowalski", img: "https://images.unsplash.com/photo-1677756119517-756a188d2d94?w=1400&q=85", excerpt: "The sales-and-AI conversation has moved past 'will it replace SDRs?' to the more useful question: which exact tasks should you offload, and which should stay human?" },
  { slug: "google-ads-2026-changes", title: "What changed in Google Ads in Q1 2026 — and what it means for budgets", cat: "Paid Media", date: "Apr 20, 2026", read: "7 min", author: "Elena Vargas", img: "https://images.unsplash.com/photo-1611926653458-09294b3142bf?w=1400&q=85", excerpt: "Performance Max keeps getting more autonomous, manual exclusions keep getting weaker, and YouTube placements are eating Search budget. Here's how we're adjusting." },
  { slug: "wcag-22-aa-checklist", title: "The complete WCAG 2.2 AA checklist for marketing websites", cat: "Accessibility", date: "Apr 13, 2026", read: "14 min", author: "Priya Sharma", img: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1400&q=85", excerpt: "Accessibility isn't a moral nice-to-have any more — it's a legal floor. Here's the full checklist we run every site through before we ship." },
  { slug: "shopify-headless-2026", title: "Should you go headless on Shopify in 2026? A flowchart.", cat: "E-commerce", date: "Apr 06, 2026", read: "8 min", author: "Marcus Reyes", img: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=1400&q=85", excerpt: "Headless Shopify with Hydrogen is now genuinely production-ready. But it's also genuinely overkill for 80% of stores. Here's how we decide." },
  { slug: "hubspot-vs-salesforce-2026", title: "HubSpot vs Salesforce in 2026 — what changed, and who wins", cat: "Automation", date: "Mar 30, 2026", read: "11 min", author: "Sam Kowalski", img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1400&q=85", excerpt: "The old rule was Salesforce for enterprise, HubSpot for SMB. In 2026 the line has moved. Here's where we land in 2026 — and the three questions that decide for any specific business." },
  { slug: "south-florida-local-seo", title: "Local SEO playbook for South Florida service businesses", cat: "SEO", date: "Mar 23, 2026", read: "13 min", author: "Elena Vargas", img: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=1400&q=85", excerpt: "Ranking in Broward is not the same problem as ranking in Miami-Dade. Here's the playbook we run across 67 South Florida service businesses." },
  { slug: "klaviyo-flows-roi", title: "The 7 Klaviyo flows that pay for the rest of your marketing stack", cat: "E-commerce", date: "Mar 16, 2026", read: "9 min", author: "Elena Vargas", img: "https://images.unsplash.com/photo-1596526131083-e8c633c948d2?w=1400&q=85", excerpt: "If your store has crossed the seven-figure mark and you are not running these seven flows, you are leaving money on the table — usually around 20% of total revenue." },
  { slug: "ai-content-quality-bar", title: "Where AI content stops being slop — a 2026 quality framework", cat: "AI", date: "Mar 09, 2026", read: "10 min", author: "Diego Alvarez", img: "https://images.unsplash.com/photo-1655720828018-edd2daec9349?w=1400&q=85", excerpt: "AI-written content has earned a bad reputation, mostly deserved. But the gap between 'AI slop' and 'indistinguishable from human' comes down to four production-process changes." },
  { slug: "elementor-vs-gutenberg-2026", title: "Elementor vs Gutenberg in 2026 — and why we still pick both", cat: "WordPress", date: "Mar 02, 2026", read: "8 min", author: "Jordan Thompson", img: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=1400&q=85", excerpt: "WordPress's block editor has finally matured. Elementor is no longer obviously the right choice. Here's how we pick between them — sometimes on the same project." },
  { slug: "meta-ads-ios-attribution", title: "Meta Ads after the iOS dust settled — the real attribution playbook", cat: "Paid Media", date: "Feb 23, 2026", read: "11 min", author: "Elena Vargas", img: "https://images.unsplash.com/photo-1611926653458-09294b3142bf?w=1400&q=85", excerpt: "iOS 14.5 was supposed to kill Facebook ads. It didn't — but it changed how you have to measure them. Here's the modeled-attribution setup that actually works." },
  { slug: "design-systems-small-teams", title: "Design systems for teams of one — a pragmatic Figma playbook", cat: "Design", date: "Feb 16, 2026", read: "9 min", author: "Diego Alvarez", img: "https://images.unsplash.com/photo-1561070791-2526d30994b8?w=1400&q=85", excerpt: "You don't need 200 components to have a design system. Here's the minimum viable Figma library we ship with every brand engagement." },
  { slug: "ga4-server-side-tracking", title: "GA4 server-side tracking — when it's worth the setup", cat: "Data", date: "Feb 09, 2026", read: "10 min", author: "Jordan Thompson", img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1400&q=85", excerpt: "Server-side GTM solves the ad-blocker and iOS-tracking problems — but adds a real layer of infrastructure. Here's where the ROI flips positive." },
  { slug: "tiktok-shop-2026", title: "TikTok Shop in 2026 — should you be on it?", cat: "E-commerce", date: "Feb 02, 2026", read: "7 min", author: "Diego Alvarez", img: "https://images.unsplash.com/photo-1611605698335-8b1569810432?w=1400&q=85", excerpt: "TikTok Shop is no longer experimental. Three categories are winning hard, two are bleeding cash, and one is wildly underrated. Here's our 2026 read." },
  { slug: "wordpress-security-2026", title: "WordPress security in 2026 — the checklist we run on every site", cat: "WordPress", date: "Jan 26, 2026", read: "12 min", author: "Jordan Thompson", img: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1400&q=85", excerpt: "WordPress powers 43% of the web, which means it's also the single largest target. Here's the practical security checklist we run on every site we host." },
  { slug: "lead-scoring-models", title: "Building a lead-scoring model that actually predicts revenue", cat: "Automation", date: "Jan 19, 2026", read: "11 min", author: "Sam Kowalski", img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1400&q=85", excerpt: "Most lead-scoring models are vibes wrapped in math. Here's how we build models that demonstrably correlate with close rate and contract size." },
  { slug: "rebrand-without-losing-seo", title: "How to rebrand without losing your SEO", cat: "SEO", date: "Jan 12, 2026", read: "9 min", author: "Priya Sharma", img: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=1400&q=85", excerpt: "Rebranding usually means a new domain, new URL structure, and a terrifying drop in organic traffic. It doesn't have to. Here's the redirect-and-content map we use." },
  { slug: "agency-pricing-2026", title: "Why we publish our prices in 2026 (and you should too)", cat: "Agency Life", date: "Jan 05, 2026", read: "6 min", author: "Marcus Reyes", img: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=1400&q=85", excerpt: "Most agencies hide their pricing. We've published ours since 2023, and the data on what it does to lead quality is unambiguous." },
];
...
const FAQS = [
  ...
  { q: "Do you work with businesses outside of South Florida?", a: "Yes. About 40% of our clients are based outside Florida — we work remotely with brands across the US, Canada, and the UK. Our office and team are in Fort Lauderdale but our delivery model is location-agnostic.", group: "Engagement" },
  ...
  { q: "Who actually does the work — you or subcontractors?", a: "Our 38-person team in Fort Lauderdale does the work. We don't subcontract design or development. We occasionally bring in specialist freelancers for photography, video production, or niche tax/compliance work — always disclosed up front.", group: "Process" },
  { q: "Do you do white-label work for other agencies?", a: "Yes. About 15% of our revenue is white-label development for design and marketing agencies who need a senior WordPress, Shopify, or AI engineering bench. See our White Label page for the partnership program.", group: "Engagement" },
...
const TEAM = [
  { n: "Roy", r: "Founder & Lead Strategist", bio: "Founded Royal Eagle in Fort Lauderdale. Hands-on through every engagement — from first call to post-launch. Twelve years of web, WordPress, and marketing work across South Florida.", img: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=600&q=85" },
  { n: "Priya Sharma", r: "Senior WordPress Engineer", bio: "WordPress and Elementor specialist. Handles custom theme development, plugin builds, and the technical work behind every site we ship.", img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600&q=85" },
  { n: "Diego Alvarez", r: "Design Lead", bio: "Brand and product designer. Leads the design phase of every project — from wireframes to final visual direction.", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=85" },
  { n: "Elena Vargas", r: "PPC & Performance", bio: "Google Ads certified specialist. Runs the paid search and Meta ad programs for our retainer clients.", img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=600&q=85" },
  { n: "Lauren Marsh", r: "Content & Email", bio: "Editorial lead. Handles long-form content, email campaigns, and AI-assisted content production for clients.", img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=600&q=85" },
  { n: "David Okafor", r: "Automation Engineer", bio: "HubSpot, Zapier, and custom integration builds. Connects the systems behind your marketing operation.", img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=600&q=85" },
];
